...
public class HomePageLoadTimeCheck_JungleeTeenPatti{
	private static int flag;
	static long totalTimeTaken;

	static String url ="http://www.jungleeteenpatti.com";
	static Logger homePageloadingTime = Logger.getLogger(HomePageLoadTimeCheck_JungleeTeenPatti.class);
