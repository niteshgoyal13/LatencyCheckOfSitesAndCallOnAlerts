...
public class HomePageLoadTimeCheck_AdminUrl{
	private static int flag;
	static long totalTimeTaken;
	static String url="https://rum.jungleerummy.com/admin/";

	static Logger homePageloadingTime = Logger.getLogger(HomePageLoadTimeCheck_AdminUrl.class);
